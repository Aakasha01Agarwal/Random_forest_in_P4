...
// This is where I am applying the action.txt based on the class type I am giving the port number.
           // if (meta.class == 0){
               // port = 2;
            //}
            //if (meta.class == 1){
...
// Setting the classication
    ...
    action CheckFeature(bit<16> node_id, bit<16> feat, bit<16> threshold){
        ...
        if (feat == 0){
            feature =(bit<16>) hdr.ipv4.protocol;
        }

        if (feat == 1){
            feature = (bit<16>)hdr.tcp.srcPort;
        }

        if (feat == 2){
            feature = (bit<16>)hdr.tcp.dstPort;
        }
    ...
    if ( hdr.ipv4.isValid()) {
         if (hdr.ipv4.protocol == 6 ) {
            ...
            if (meta.class == CLASS_NOT_SET) {
                  ...
                  }  // end of hdr.ipv4.protocol == 6 || hdr.ipv4.protocol == 17
